...
json_t *json_pack_ex(json_error_t *m_error, size_t flags, const char *fmt, ...)
    JANSSON_ATTRS((warn_unused_result));
json_t *json_vpack_ex(json_error_t *m_error, size_t flags, const char *fmt, va_list ap)
    JANSSON_ATTRS((warn_unused_result));
...
int json_unpack_ex(json_t *root, json_error_t *m_error, size_t flags, const char *fmt, ...);
int json_vunpack_ex(json_t *root, json_error_t *m_error, size_t flags, const char *fmt,
                    va_list ap);
...
json_t *json_loads(const char *input, size_t flags, json_error_t *m_error)
    JANSSON_ATTRS((warn_unused_result));
json_t *json_loadb(const char *buffer, size_t buflen, size_t flags, json_error_t *m_error)
    JANSSON_ATTRS((warn_unused_result));
json_t *json_loadf(FILE *input, size_t flags, json_error_t *m_error)
    JANSSON_ATTRS((warn_unused_result));
json_t *json_loadfd(int input, size_t flags, json_error_t *m_error)
    JANSSON_ATTRS((warn_unused_result));
json_t *json_load_file(const char *path, size_t flags, json_error_t *m_error)
    JANSSON_ATTRS((warn_unused_result));
json_t *json_load_callback(json_load_callback_t callback, void *data, size_t flags,
                           json_error_t *m_error) JANSSON_ATTRS((warn_unused_result));
