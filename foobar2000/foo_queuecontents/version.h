...
#define COMPONENT_VERSION_SUB_PATCH 6

#define BETA_VER

#define MAKE_STRING(text) #text
#ifdef BETA_VER
#define MAKE_COMPONENT_VERSION(major,minor,patch, subpatch) MAKE_STRING(major) "." MAKE_STRING(minor) " beta " MAKE_STRING(subpatch)
#endif
...
#define FOO_COMPONENT_VERSION MAKE_COMPONENT_VERSION(COMPONENT_VERSION_MAJOR,COMPONENT_VERSION_MINOR, COMPONENT_VERSION_PATCH, COMPONENT_VERSION_SUB_PATCH)
//0.1.2.3 & "0.1.2.3"
